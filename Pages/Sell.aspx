...
<div id="main">
    ...
    <div style="display:flex">
     ...
     <table class="auto-style3 p-5">
            ...
            <tr>
                ...
                <td class="auto-style10">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryWebDatabse %>" SelectCommand="SELECT [name] FROM [products] WHERE ([company] = @company)" OnSelecting="SqlDataSource1_Selecting">
                        <SelectParameters>
            ...
            <tr>
                ...
                <td class="auto-style15">
                    <asp:TextBox ID="TextBox10" runat="server" Width="300px" TextMode="Date" OnTextChanged="TextBox10_TextChanged"></asp:TextBox>
                </td>
     ...
     <div class="pt-3">
              <td class="auto-style13 ">
              <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="Create in Invoice" Width="437px" Height="30px" />
              </td>
     </div>
    </div>

    <div class="auto-style18 pl-3">
        <div>
                    <div class="p-4">
                           <asp:Label ID="Label25" runat="server" Text="Inv Date" Font-Bold="True" Font-Size="Medium"></asp:Label>
                           <asp:TextBox ID="TextBox11" runat="server" Width="145px" TextMode="Date"></asp:TextBox>
                           <asp:Label ID="Label24" runat="server" Text="To" Font-Bold="True" Font-Size="Medium"></asp:Label>       
                           <asp:TextBox ID="TextBox12" runat="server" Width="145px" TextMode="Date"></asp:TextBox>
                           <asp:Label ID="Label11" runat="server" Text="Cust Id" Font-Bold="True" Font-Size="Medium"></asp:Label>
                            <asp:DropDownList ID="DropDownList8" runat="server" DataSourceID="SqlDataSource7" DataTextField="id" DataValueField="id" Width="54px" AutoPostBack="True" ReadOnly="True" CssClass="auto-style17" Height="24px">
                            </asp:DropDownList>
                               
                    &nbsp;<asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="Match Invoice" Width="103px" />
                           <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="Show All" Width="66px" />
                           <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="Selected Cust Due" Width="128px" Height="26px" />
                           <asp:Button ID="Button7" runat="server" OnClick="Button7_Click" Text="All Due" Width="60px" />
                    </div>
                    <div style="text-align:left" class="pb-3">
                      ...
                      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="id" DataSourceID="SqlDataSource6" ForeColor="#333333" GridLines="None" Height="146px" Width="817px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryWebDatabse %>" DeleteCommand="DELETE FROM [cust_inv] WHERE [id] = @id" InsertCommand="INSERT INTO [cust_inv] ([customer_id], [customer_name], [total_ammount], [recieve_ammount], [due], [created_date], [created_by], [dv_name]) VALUES (@customer_id, @customer_name, @total_ammount, @recieve_ammount, @due, @created_date, @created_by, @dv_name)" SelectCommand="SELECT * FROM [cust_inv] WHERE ([customer_id] = @customer_id) AND [created_date] between @d1 AND @d2" UpdateCommand="UPDATE [cust_inv] SET [customer_id] = @customer_id, [customer_name] = @customer_name, [total_ammount] = @total_ammount, [recieve_ammount] = @recieve_ammount, [due] = @due, [created_date] = @created_date, [created_by] = @created_by, [dv_name] = @dv_name WHERE [id] = @id">
                        <DeleteParameters>
                            <asp:Parameter Name="id" Type="Int32" />
                        </DeleteParameters>
                        <InsertParameters>
                        ...
                        <SelectParameters>
                            <asp:ControlParameter ControlID="DropDownList8" Name="customer_id" PropertyName="SelectedValue" Type="Int32" />
                            <asp:ControlParameter ControlID="TextBox11" Name="d1" PropertyName="Text" />
                            <asp:ControlParameter ControlID="TextBox12" Name="d2" PropertyName="Text" />
                        </SelectParameters>
                        <UpdateParameters>
                            <asp:Parameter Name="customer_id" Type="Int32" />
                            <asp:Parameter Name="customer_name" Type="String" />
        ...
        <div class="pt-5">
               <div style="text-align:left" class="pb-3">
                        <td class="auto-style3" >
                                    <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryWebDatabse %>" SelectCommand="SELECT * FROM [cust_inv] WHERE ([customer_id] = @customer_id) AND [due] &gt;1">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="DropDownList8" Name="customer_id" PropertyName="SelectedValue" />
                                        </SelectParameters>
                        </asp:SqlDataSource>
                                    <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:InventoryWebDatabse %>" SelectCommand="SELECT * FROM [cust_inv] WHERE  [due] &gt;1"></asp:SqlDataSource>
