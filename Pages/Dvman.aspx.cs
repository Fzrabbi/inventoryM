...
{
    public partial class Dvman : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string querry = "insert into dv ([dv_name], [dv_area]) values(@dname, @darea)";
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand(querry, sqlCon))
                {
                    ...
                    cmd.Parameters.Add("@dname", SqlDbType.NVarChar).Value = TextBox3.Text;
                    cmd.Parameters.Add("@darea", SqlDbType.NVarChar).Value = DropDownList1.Text;
